...
export class DoughnutChart extends Component {
  static template = "mba_bi_dashboard.DoughnutChart";
  static props = {
    chartId: String,
    name: String,
  ...
  render_doughnut_chart() {
    ...
    const container = document.getElementById("doughnut_chart__" + this.props.chartId);
    ...
    const option = {
      ...
      series: [
        {
          name: this.props.name || "Doughnut Chart",
          type: "pie",
          radius: ["42%", "68%"],
          center: ["50%", "45%"],
    ...
    this.chartInstance.on("click", (params) => {
      if (this.props.update_chart && params.data) {
        this.props.update_chart(parseInt(this.props.chartId), "doughnut_chart", {
