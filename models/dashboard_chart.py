...
class DashboardChart(models.Model):
    ...
    def name_search(self, name="", args=None, operator="ilike", limit=100):
        ...
        if context.get("is_automated"):
            ...
            domain = expression.AND([domain_list, domain])
    ...
    def html_to_image(self):
        ...
        if self.chart_type == "list":
            ...
            template_html = self.env["ir.ui.view"]._render_template(
                "mba_bi_dashboard.list_layout", {"recordsets": recordsets}
            )
            ...
            if recordsets.get("layout_type") == "activity":
                ...
                template_html = self.env["ir.ui.view"]._render_template(
                    "mba_bi_dashboard.to_do_layout", {"recordsets": recordsets}
                )
                template_html = f"""<div class="col-sm-12 col-md-12 oe_inner">
                                                                {template_html}
                                                            </div>"""
            ...
            kpi_layout_options = {
                "layout1": "mba_bi_dashboard.kpi_layout_one",
                "layout2": "mba_bi_dashboard.kpi_layout_two",
                "layout3": "mba_bi_dashboard.kpi_layout_three",
                "layout4": "mba_bi_dashboard.kpi_layout_four",
                "layout5": "mba_bi_dashboard.kpi_layout_five",
            }
            tile_layout_options = {
                "layout1": "mba_bi_dashboard.tile_layout_one",
                "layout2": "mba_bi_dashboard.tile_layout_two",
                "layout3": "mba_bi_dashboard.tile_layout_three",
                "layout4": "mba_bi_dashboard.tile_layout_four",
            }
        ...
        if not imgkit:
            _logger.warning("imgkit library not installed, returning empty image data.")
            return ""
        try:
            options = {
                "encoding": "UTF-8",
            ...
            _logger.warning("Error generating imgkit binary: %s", str(e))
            return ""
